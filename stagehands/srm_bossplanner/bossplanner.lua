...
function spawnBoss(bossParameters, bossUid, seed)
  bossParameters.shortdescription = root.generateName("/monsters/boss/srm_corruptedguardianboss/bossnamegen.config:names", seed)
  bossParameters.managerUid = entity.uniqueId()
  bossParameters.level = 7
  bossParameters.uniqueId = bossUid
  bossParameters.seed = seed
  return world.spawnMonster(string.format("srm_corrupted%sguardianboss", storage.elementalType), entity.position(), bossParameters)
end
