function init()
	...
	if self.sensorConfig then
		...
		self.sensorConfig.detectDuration = self.sensorConfig.detectDuration or 0.1
	...
	message.setHandler("openDoor", function() closeDoor() end)
	message.setHandler("closeDoor", function() openDoor() end)
