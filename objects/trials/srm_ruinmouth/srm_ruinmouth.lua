...
function updateInteractive()
	object.setInteractive(config.getParameter("interactive", true) and not self.sensorConfig and not object.isInputNodeConnected(0))
end
...
function unlockDoor()
	if storage.locked then
		object.setConfigParameter("locked", false)
